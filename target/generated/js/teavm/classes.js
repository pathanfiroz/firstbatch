...
function $rt_str(str) {if (str === null) {return null;}var characters = $rt_createCharArray(str.length);var charsBuffer = characters.data;for (var i = 0; i < str.length; i = (i + 1) | 0) {charsBuffer[i] = str.charCodeAt(i) & 0xFFFF;}return Ch(characters);}
...
var BX=$rt_throw;var Co=$rt_compare;var Cp=$rt_nullCheck;var BZ=$rt_cls;var Ci=$rt_createArray;var Cq=$rt_isInstance;var Cr=$rt_nativeThread;var Cs=$rt_suspending;var Ct=$rt_resuming;var Cu=$rt_invalidPointer;var C=$rt_s;var BJ=$rt_eraseClinit;var Cv=$rt_imul;var Cw=$rt_wrapException;
function B(){this.$id$=0;}
function BG(a){return B0(a.constructor);}
function B$(a){var b,c,d,e,f,g,h,i,j,k;b=new Bb;b.a=$rt_createCharArray(16);b=T(T(b,BP(BG(a))),C(0));c=BO(a);if(!c)d=C(1);else{if(!c)e=32;else{f=0;e=c>>>16;if(e)f=16;else e=c;g=e>>>8;if(!g)g=e;else f=f|8;e=g>>>4;if(!e)e=g;else f=f|4;g=e>>>2;if(!g)g=e;else f=f|2;if(g>>>1)f=f|1;e=(32-f|0)-1|0;}e=(((32-e|0)+4|0)-1|0)/4|0;h=$rt_createCharArray(e);i=h.data;g=(e-1|0)*4|0;j=0;while(g>=0){k=j+1|0;f=c>>>g&15;i[j]=f>=16?0:f<10?(48+f|0)&65535:((97+f|0)-10|0)&65535;g=g-4|0;j=k;}d=Ch(h);}return BE(T(b,d));}
function BO(a){var b,c;b=a;if(!b.$id$){c=$rt_nextId();b.$id$=c;}return a.$id$;}
function By(){B.call(this);}
function Cl(b){var c,d,e;BD();Bx();BM();c=window.document;d=c.createElement("div");e=c.createTextNode("TeaVM generated element");d.appendChild(e);c.body.appendChild(d);}
function Ba(){}
...
var Cx=null;function Ch(a){var b=new O();BC(b,a);return b;}
...
function Bs(a,b,c){var d,e,f;if(b>=0&&b<=a.c){a:{if(c===null)c=C(2);else if(Bw(c))break a;Bz(a,a.c+E(c)|0);d=a.c-1|0;while(d>=b){a.a.data[d+E(c)|0]=a.a.data[d];d=d+(-1)|0;}a.c=a.c+E(c)|0;d=0;while(d<E(c)){e=a.a.data;f=b+1|0;e[b]=V(c,d);d=d+1|0;b=f;}}return a;}BX(B4());}
...
function Bz(a,b){var c,d,e,f;if(a.a.data.length<b){b=a.a.data.length>=1073741823?2147483647:BB(b,BB(a.a.data.length*2|0,5));c=a.a.data;d=$rt_createCharArray(b);e=c.length;if(b<e)e=b;f=d.data;b=0;while(b<e){f[b]=c[b];b=b+1|0;}a.a=d;}}
...
var CD=null;var CE=null;function BM(){CD=BZ($rt_charcls());CE=Ci(N,128);}
...
$rt_metadata([B,"Object",1,0,[],0,3,0,0,By,0,B,[],0,3,0,0,Ba,0,B,[],3,3,0,0,Bp,0,B,[Ba],0,3,0,0,BS,0,B,[],4,0,0,0,BH,0,B,[],4,3,0,0,L,0,B,[],3,3,0,0,M,0,B,[],3,3,0,0,P,0,B,[],3,3,0,0,O,0,B,[L,M,P],0,3,0,0,J,0,B,[],0,3,0,0,R,0,J,[],0,3,0,0,H,0,R,[],0,3,0,0,BF,0,H,[],0,3,0,0,S,0,B,[L,P],0,0,0,0,Bu,0,B,[],3,3,0,0,Bb,0,S,[Bu],0,3,0,0,U,0,B,[L],1,3,0,0,Bg,0,U,[M],0,3,0,0,K,0,H,[],0,3,0,0,BN,0,K,[],0,3,0,0,BQ,0,K,[],0,3,0,0,W,0,J,[],0,3,0,0,X,0,W,[],0,3,0,0,I,0,B,[],3,3,0,0,Bf,0,B,[I],3,3,0,0,Bm,0,B,[Bf],3,3,0,0,F,
